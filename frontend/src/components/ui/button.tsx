  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-to-r from-primary to-secondary text-primary-foreground font-bold shadow-xl shadow-primary/30 hover:shadow-primary/50 hover:scale-105",
        heroOutline: "border-2 border-white/30 bg-white/5 text-foreground backdrop-blur-sm hover:bg-white/10 hover:border-white/50",
        glass: "bg-white/10 backdrop-blur-md border border-white/20 text-foreground hover:bg-white/20",
        neon: "bg-transparent border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground shadow-lg shadow-primary/30 hover:shadow-primary/50",
      },
      size: {
